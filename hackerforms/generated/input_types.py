...
class ListInput(Input):
    ...
    def json(self, **kwargs):
        overloaded_schemas = self.__get_overloaded_schemas(kwargs.get("payload").get(self.key) if kwargs.get("payload") else None)
        overloaded_schemas = { "overloadedItemSchemas": overloaded_schemas } if overloaded_schemas else {}
    ...
    def __get_overloaded_schemas(self, payload):
        if payload:
            return [
                    self.item_schema.json(payload=payload_item)
