...
def check_version():
  try:
    libs = requests.get("https://hackerforms-api.abstra.cloud/public/abstra-pypi-packages").json()
    ...
    if hackerforms['version'] != __version__ and __version__ != '0.0.0':
      ...
      print("Please update your library using the following command: pip install hackerforms==" + hackerforms['version'])
